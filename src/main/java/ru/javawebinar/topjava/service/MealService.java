...
public class MealService {
    ...
    public void update(MealToIn mealToIn, int userId) {
        Meal meal = get(mealToIn.getId(), userId);
        checkNotFoundWithId(repository.save(MealsUtil.updateFromTo(meal, mealToIn), userId), meal.getId());
    }
